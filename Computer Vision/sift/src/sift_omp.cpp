...
// void sym_guassian_1d(const gray_t* sym_filter, const gray_t* pre_sym_filter, gray_t* img_src, gray_t* img_dst, int n, int m) {}
...
/*  	sigma：高斯模糊参数
/********************************************************************/
// void _guassian_smooth(const gray_t* img_src, gray_t** img_dst_ptr, int n, int m, double sigma) {
